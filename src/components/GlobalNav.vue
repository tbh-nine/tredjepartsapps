  ...
  <header class="header" data-cy="global-header">
    <div class="portal-header">
      <div class="container portal-header-inner content-header-inner">
        <a href="#" class="logo" data-cy="logo" aria-label="Virksomhedsguiden" title="Virksomhedsguiden" />
        <button
          id="openMenu"
        ...
        >
          <img src="@/assets/menu.svg" alt="menu-icon" title="Åben mobil menu" />
          <span>Menu</span>
        </button>
    ...
    <nav class="nav" aria-label="Hovedmenu">
      <button class="button button-tertiary button-menu-close js-menu-close" title="Menu">
